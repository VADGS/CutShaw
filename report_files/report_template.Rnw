...
\title{DCLS WGS Competency Assessment\protect\\CutShaw Report for: \protect\\[0.2in]"Title goes here"}
\author{Report genereated by Kevin G. Libuit,\protect\\ DCL Bioinformatics Lead Scientist}
...
\\textbf{1. Taxonomy} - the accuracy of the taxonomic annotation\n
